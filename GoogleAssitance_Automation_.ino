...
#define WLAN_SSID       "rishu"            // wifi name
#define WLAN_PASS       "rishu@759"       //wifi password
#define AIO_SERVER      "io.adafruit.com"   // server site
#define AIO_SERVERPORT  1883                   
#define AIO_USERNAME    "rishu"         // user name
#define AIO_KEY         "50a98bb44f6b48b69df8fb577894"  // authentication key
